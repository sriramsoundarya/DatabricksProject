...
# MAGIC %sql
# MAGIC create or replace temp view encounters1
# MAGIC using parquet
# MAGIC options (
# MAGIC   path '/mnt/bronze/hosa/encounters')

# COMMAND ----------

# MAGIC %sql
# MAGIC create or replace temp view encounters2
# MAGIC using parquet
# MAGIC options (
# MAGIC   path '/mnt/bronze/hosb/encounters')

# COMMAND ----------

# MAGIC %sql
# MAGIC  SELECT * FROM encounters1
...
# MAGIC  datasource,
# MAGIC      CASE 
# MAGIC          WHEN SRC_EncounterID IS NULL OR PatientID IS NULL THEN TRUE
# MAGIC          ELSE FALSE
